            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                <li role="presentation"><a href="javascript:$('#center').load('carousel.jsp')">轮播图管理</a>
                                </li>
                                <li role="presentation"><a href="#">假数据1</a></li>
                                <li role="presentation"><a href="#">加数据2</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                <li role="presentation"><a href="javascript:$('#center').load('album.jsp')">章节和文章管理</a>
                                </li>
                                <li role="presentation"><a href="#">假数据3</a></li>
                                <li role="presentation"><a href="#">加数据4</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                <li role="presentation"><a href="javascript:$('#center').load('article.jsp')">文章管理</a>
                                </li>
                                <li role="presentation"><a href="#">假数据5</a></li>
                                <li role="presentation"><a href="#">加数据6</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li role="presentation"><a href="javascript:$('#center').load('echarts.jsp')">用户注册月份统计</a></li>
                                <li role="presentation"><a href="javascript:$('#center').load('echartsmaps.jsp')">用户注册全国地图</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
